...
gradlePlugin {
    plugins {
        create("default") {
            ...
            implementationClass = "com.blamejared.bigshot.gradle.DefaultPlugin"
        }
        create("loader") {
            id = "com.blamejared.bigshot.loader"
            implementationClass = "com.blamejared.bigshot.gradle.LoaderPlugin"
        }
    }
}
